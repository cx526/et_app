			...
			<view class="list-content-father-position">
				<view class="list-content-father-position" v-if="listData.length > 0">
					...
					<view class="list-content-position" v-if="isHidden === 0">
						<view v-for="(item, i) in listData" :key="i"><et-imgbox :bookInfo="item.goods_info" @insertBookToCart="insertBookToCart" :lineType="item.lineType"></et-imgbox></view>
					</view>
				...
				<view class="empty-style" v-if="listStatus === 0"><text>列表空空如也</text></view>
			</view>
		</view>
