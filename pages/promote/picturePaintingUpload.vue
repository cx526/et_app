	...
	<view class="content">
		...
		<view class="content-position">
			...
			<view class="middle-conten-position white-border" style="margin-top: 30upx;">
				<view class="top-content">
					<text class="spacing">绘本名称</text>
					<input type="text" :value="inputText"  placeholder="请输入参考作画绘本名称" @input="inputChange"/>
				</view>
...
.top-position {
	/* background-image: linear-gradient(to bottom, #F5F5F5 , #88E3FE); */
	background-color: rgba(203,225,152,1);
...
.intergal-type {
	background-color: rgba(120,188,85,1);
	border-radius: 30upx;
	padding: 5upx 10upx;
}
